...
{
    public async Task AddPrescription(AddPrescriptionRequestDto prescriptionRequestDto)
    {
            ...
            while (await reader.ReadAsync())
            {
                ...
                if (!prescriptionsDict.ContainsKey(prescriptionId))
                {
                    prescriptionsDict[prescriptionId] = new PrescriptionDto()
                    {
                        ...
                        Medicaments = new List<GetMedicamentDto>()
                    };
                }

                prescriptionsDict[prescriptionId].Medicaments.Add(new GetMedicamentDto()
                {
